...
class Drone : public IEntity {
 public:
  ...
  /**
   * @brief Calculates the current trip length.
   * @return The length of the current trip.
   */
  float calculateTripLength();

 private:
  bool available = false;
  bool pickedUp = false;
  float lengthToPickup;
  ...
  std::string destinationsToString() const;
};
